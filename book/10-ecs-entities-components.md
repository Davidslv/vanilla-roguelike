...
player: "Player Entity" {
  c1: "PositionComponent (shared)"
  c2: "RenderComponent (shared)"
  c3: "HealthComponent (shared)"
  c4: "MovementComponent (shared)"
  c5: "InputComponent"
  c6: "InventoryComponent"
  c1 -> c2: {style.opacity: 0}
  c2 -> c3: {style.opacity: 0}
