  ...
  describe '#handle_input' do
    context 'with movement keys' do
      it 'creates and executes up movement command' do
        ...
        expect(Vanilla::Commands::MoveCommand).to receive(:new).with(entity, :up, grid).and_return(move_command)
      ...
      it 'creates and executes down movement command' do
        ...
        expect(Vanilla::Commands::MoveCommand).to receive(:new).with(entity, :down, grid).and_return(move_command)
        expect(move_command).to receive(:execute)
      ...
      it 'creates and executes right movement command' do
        ...
        expect(Vanilla::Commands::MoveCommand).to receive(:new).with(entity, :right, grid).and_return(move_command)
        expect(move_command).to receive(:execute)
      ...
      it 'creates and executes left movement command' do
        ...
        expect(Vanilla::Commands::MoveCommand).to receive(:new).with(entity, :left, grid).and_return(move_command)
        expect(move_command).to receive(:execute)
